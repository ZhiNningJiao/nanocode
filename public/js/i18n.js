...
const translations = {
  en: {
    ...
    'plugins.model.desc': 'Pick an AIGW litellm model for opencode / fable5 sessions.',
    ...
    'domain.empty': 'Nothing here yet — enable a plugin in Ops → Plugins.',
    ...
    'plugin.usage.desc': 'Claude JSONL token aggregation + AIGW cost probe.',
  ...
  zh: {
    ...
    'plugins.model.desc': '为 opencode / fable5 会话选择 AIGW litellm 模型。',
    ...
    'domain.session': '会话',
    'domain.ops': '监控',
    'domain.artifacts': '工作区',
    'domain.empty': '此域暂无内容 — 在 监控 → 插件 中启用插件。',
    'mobile.terminal': '终端',
    'mobile.panel': '面板',
    'plugin.teammodel.label': 'Team 与模型',
    'plugin.teammodel.desc': '切换新会话的 Claude 配置目录并选择模型。',
    'plugin.usage.label': '用量',
    'plugin.usage.desc': 'Claude JSONL token 聚合 + AIGW 成本探测。',
